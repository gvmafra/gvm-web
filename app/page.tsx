  ...
  return (
    <main className="flex flex-col md:flex-row h-auto md:h-screen items-center justify-between">
      ...
      <div className="w-full h-full md:p-20 md:px-40">
        <div className="flex w-full h-full min-h-[600px] md:min-h-max items-center justify-center md:rounded-2xl dark:invert shadow-[0_10px_15px_2px_rgb(0,0,0,0.4)] md:shadow-[0_0_15px_2px_rgb(0,0,0,0.4)]">
